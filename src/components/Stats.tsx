    ...
    <div>
      <section className="bg-[#030315] dark:bg-white dark:text-[#030315] text-white body-font py-10">
        <div className="w-full pt-6 px-8 md:px-20 text-center">
            <h1 className="font-bold text-2xl md:text-5xl my-3">Your Link Performance at a Glance</h1>
            <p className="md:text-2xl text-lg my-3">Track key metrics like total clicks, top links, and audience engagement in real-time.</p>
        </div>
